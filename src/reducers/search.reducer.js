...
const SearchReducer = (state = initialState, action) => {
  switch (action.type) {
    case SearchActionType.FIND_ITEMS_SUCCESS:
      return Object.assign({}, state, {itemList: [...action.payload.data.items.promoted, ...action.payload.data.items.regular], totalCount: action.payload.data.searchMeta.totalCount});
    ...
    case SearchActionType.CLEAR_ITEMS:
      return {...state, itemList: [], totalCount: 0};
